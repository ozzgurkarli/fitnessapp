                      ...
                      children: [
                        SizedBox(
                          ...
                          child: CustomizedTextField(SignUp.nameController,
                              ConstantText.NAME[ConstantText.index], false, false, false),
                        ),
                        SizedBox(
                        ...
                        SizedBox(
                          ...
                          child: CustomizedTextField(SignUp.surnameController,
                              ConstantText.SURNAME[ConstantText.index], false, false, false),
                        ),
                      ],
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: CustomizedTextField(SignUp.invitationCodeController,
                          ConstantText.INVITATIONCODE[ConstantText.index], false, false, false),
                    ),
                  ),
                  SizedBox(
                    height: Sizes.height / 17,
