...
class _WorkoutHistoryDetailState extends State<WorkoutHistoryDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    heaviestWeight = context.read<CubitWorkoutHistory>().findHeaviestWeight(widget.moveList);
    return Scaffold(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              SizedBox(width: Sizes.width/10,),
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(
                                    widget.moveList[index]["moveName"]!,
                                    style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: ColorC.thirdColor),
                                  ),
                                  Text(
                                    widget.moveList[index]["muscle"]!,
                                    style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: ColorC.backgroundColor),
                                  )
                                ],
                              ),
                              Spacer(),
